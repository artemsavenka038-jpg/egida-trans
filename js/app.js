...
function App() {
  ...
  const addMecTrailer = (plate)=>{ var id='mp_'+Date.now(); var obj={id,plate:(plate||'').trim(),econ:'',pairedTractor:'',toMileage:'',tireMileage:'',frc:'',unitService:'',insurance:'',kasko:'',akbDate:'',note:''}; setMecTrailers(prev=>{ var n=prev.concat([obj]); cacheSet('mec_trailers',n); return n; }); saveOr('/mechanic/trailers/'+id,obj,'Прицеп добавлен'); };

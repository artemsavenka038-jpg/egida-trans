...
function PlanGrid({plans,clients,orders,trucks,geoIndex,onSavePlan,onDelPlan,onLaunch,onAddOrder,onSetBar}){
...
function AppMain() {
  ...
  return ce('div',{style:{minHeight:'100vh',color:'var(--text)'}},
    ...
    tab==='grid'&&ce(PlanGrid,{plans:plans,clients:clients,orders:orders,trucks:trucks,geoIndex:geoIndex,

      ...
      return ce('div',{key:k,style:{marginBottom:18}},
        ...
        (function(){
          var renderRow=function(p){
            ...
            return ce('div',{key:p.id,className:'fl-row-hover',style:{display:'flex',alignItems:'center',gap:12,padding:'9px 12px',borderRadius:9,
              ...
              ce('div',{style:{flex:1,minWidth:0}},
                ...
                p.back?ce('div',{style:{fontSize:11,color:'var(--cyan)',marginTop:1,whiteSpace:'nowrap',overflow:'hidden',textOverflow:'ellipsis'}},'↩ обратка: '+p.back)
              ...
              // ── справа: статус + действия (появляются при наведении) ──
              launched?
                ce('div',{style:{display:'flex',alignItems:'center',gap:8,flexShrink:0}},
                  ...
                  ce('button',{className:'fl-press fl-row-act',onClick:function(){setEdit(p);},title:'Изменить и переназначить',style:{width:26,height:26,borderRadius:6,border:'1px solid var(--border2)',background:'var(--bg3)',color:'var(--text3)',cursor:'pointer',fontSize:12}},'✎'),
                  ce('button',{className:'fl-press fl-row-act',onClick:function(){ if(window.confirm('Убрать строку из плана? Рейс в «Рейсах» останется.')) onDelPlan(p.id); },title:'Убрать из плана',style:{width:26,height:26,borderRadius:6,border:'1px solid var(--border2)',background:'transparent',color:'var(--text3)',cursor:'pointer',fontSize:12}},'✕')):
                ce('div',{style:{display:'flex',alignItems:'center',gap:6,flexShrink:0}},
                  p.driverSent?ce('span',{title:'данные водителю отправлены',style:{fontSize:13,color:'var(--green)'}},'📩'):null,
                  ce('button',{className:'fl-press fl-row-act',onClick:function(){setEdit(p);},title:'Изменить',style:{width:26,height:26,borderRadius:6,border:'1px solid var(--border2)',background:'var(--bg3)',color:'var(--text3)',cursor:'pointer',fontSize:12}},'✎'),
                  ce('button',{className:'fl-press fl-row-act',onClick:function(){ if(window.confirm('Удалить строку?')) onDelPlan(p.id); },title:'Удалить',style:{width:26,height:26,borderRadius:6,border:'1px solid var(--border2)',background:'transparent',color:'var(--text3)',cursor:'pointer',fontSize:12}},'🗑'),
                  ce('button',{className:'fl-press',onClick:function(){ if(window.confirm('Отправить в рейс: '+(p.truckDriver||p.truckPlate||'машину')+' → '+(p.clientName||'')+'?')) onLaunch(p); },
                    style:{padding:'7px 14px',borderRadius:8,border:'none',cursor:'pointer',fontFamily:'inherit',fontSize:12,fontWeight:800,color:'#fff',background:'var(--accent)'}},'▶ В рейс'))); };
          ...
          return ce('div',{style:{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12,alignItems:'start'}},
            ce('div',null,

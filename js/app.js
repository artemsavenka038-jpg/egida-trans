...
let ROLES = LOGISTS.concat(['Руководитель']);
...
function applyLogists(list){ var a=normLogists(list); if(!a||!a.length) return; LOGISTS=a.map(function(l){return l.name;}); LOGIST_COLOR={}; a.forEach(function(l){ LOGIST_COLOR[l.name]=l.color; }); ROLES=LOGISTS.concat(['Руководитель']); }
